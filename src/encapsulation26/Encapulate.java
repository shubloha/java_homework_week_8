...
public class Encapulate {
    //private variables delcared these can only be accessed by public methods of class
    private String name;
    private int rollNo;
    private int age;
    ...
    //set mehtod for name to access private variable name
